/* NeoPixel driver library
 *
 * This is free software. You can redistrubute it and/or modify
 ...
 * Parts taken from Adafruit Neopixel library (Also GPLv3 licensed, but no
 * copyright statement in file)
 */
...
struct neopixel {
	...
	uint8_t pixel_width;
	uint8_t *pixels;
	uint8_t r_off, g_off, b_off, w_off; /* Pixel colour offsets */
};
...
static inline void neopixel_set_rgb(struct neopixel *neo, uint8_t n, uint8_t r, uint8_t g, uint8_t b) {
	neopixel_set_rgbw(neo, n, r, g, b, 0);
}
